 ...
 */
 ...
 DAT.Globe = function(container, colorFn, path, accentColor) {
    ...
    'earth' : {
      ...
      fragmentShader: [
        ...
        'void main() {',
          ...
          `vec3 atmosphere = vec3(${accentColor.r}, ${accentColor.g}, ${accentColor.b}) * pow( intensity, 3.0 );`,
    ...
    'atmosphere' : {
      ...
      fragmentShader: [
        ...
        'void main() {',
          ...
          `gl_FragColor = vec4(${accentColor.r}, ${accentColor.g}, ${accentColor.b}, 0.1 ) * intensity;`,
        '}'
      ].join('\n')
    }
  };
   ...
   var rotation = { x: Math.PI*1.7, y: Math.PI / 5.0 },
   ...
   function init() {
     ...
     uniforms['texture'].value = THREE.ImageUtils.loadTexture(path);
